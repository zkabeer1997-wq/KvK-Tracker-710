...
export const HOME_FIELDS = [
  ...
  { key: 'hero-sub', text: "710 is a KvK-first kingdom run across three coordinated alliances, with Bear Hunt coverage spanning every timezone and war-room tooling most kingdoms never bother building. If you're shopping for your next server, start here." },
  ...
  { key: 'why-1-body', text: 'Three alliances, seven Bear Hunt windows spread across the clock. Whenever you log in, somebody in 710 is already rallying.' },
  ...
  { key: 'wb-head-kicker', text: 'THE THREE ALLIANCES' },
  { key: 'wb-head-title', text: 'Pick your alliance, know your hunt times' },
  { key: 'wb-head-sub', text: "Every alliance runs its own Bear Hunt schedule. Migration preference is part of the application — here's what each one covers." },
  ...
  { key: 'deck-head-sub', text: 'Quick access to the tools your alliance uses every KvK cycle.' },
