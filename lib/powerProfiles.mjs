...
export function mergePowerProfilesIntoRows(rows, powerProfiles) {
 ...
 return {
 ...row,
 infantry_tier: powerProfile?.infantry_tier || row.infantry_tier,
 infantry_tg: powerProfile?.infantry_tg || row.infantry_tg,
 cavalry_tier: powerProfile?.cavalry_tier || row.cavalry_tier,
 cavalry_tg: powerProfile?.cavalry_tg || row.cavalry_tg,
 archer_tier: powerProfile?.archer_tier || row.archer_tier,
 archer_tg: powerProfile?.archer_tg || row.archer_tg,
 heroes: powerProfile?.heroes?.length ? powerProfile.heroes : row.heroes,
