...
const heroRoster = [
  { member_id: 'chenko-1', name: 'Chenko 1', heroes: ['Chenko'], infantry_tier: 'T11', infantry_tg: 'TG8', cavalry_tier: 'T8', cavalry_tg: 'TG4', archer_tier: 'T8', archer_tg: 'TG4' },
  { member_id: 'chenko-2', name: 'Chenko 2', heroes: ['Chenko'], infantry_tier: 'T10', infantry_tg: 'TG7', cavalry_tier: 'T8', cavalry_tg: 'TG4', archer_tier: 'T8', archer_tg: 'TG4' },
  { member_id: 'yeonwoo-1', name: 'Yeonwoo 1', heroes: ['Yeonwoo'], infantry_tier: 'T8', infantry_tg: 'TG4', cavalry_tier: 'T11', cavalry_tg: 'TG8', archer_tier: 'T8', archer_tg: 'TG4' },
  { member_id: 'yeonwoo-2', name: 'Yeonwoo 2', heroes: ['Yeonwoo'], infantry_tier: 'T8', infantry_tg: 'TG4', cavalry_tier: 'T10', cavalry_tg: 'TG7', archer_tier: 'T8', archer_tg: 'TG4' },
  { member_id: 'amane-1', name: 'Amane 1', heroes: ['Amane'], infantry_tier: 'T8', infantry_tg: 'TG4', cavalry_tier: 'T8', cavalry_tg: 'TG4', archer_tier: 'T11', archer_tg: 'TG8' },
  { member_id: 'amane-2', name: 'Amane 2', heroes: ['Amane'], infantry_tier: 'T8', infantry_tg: 'TG4', cavalry_tier: 'T8', cavalry_tg: 'TG4', archer_tier: 'T10', archer_tg: 'TG7' },
  { member_id: 'amadeus-1', name: 'Amadeus 1', heroes: ['Amadeus'], infantry_tier: 'T11', infantry_tg: 'TG8', cavalry_tier: 'T11', cavalry_tg: 'TG8', archer_tier: 'T11', archer_tg: 'TG8' },
  { member_id: 'amadeus-2', name: 'Amadeus 2', heroes: ['Amadeus'], infantry_tier: 'T10', infantry_tg: 'TG7', cavalry_tier: 'T10', cavalry_tg: 'TG7', archer_tier: 'T10', archer_tg: 'TG7' },
  { member_id: 'wrong-hero', name: 'Wrong Hero', heroes: ['Vivian'], infantry_tier: 'T11', infantry_tg: 'TG8', cavalry_tier: 'T11', cavalry_tg: 'TG8', archer_tier: 'T11', archer_tg: 'TG8' },
  { member_id: 'other-rally', name: 'Other Rally', heroes: ['Chenko'], infantry_tier: 'T11', infantry_tg: 'TG8', cavalry_tier: 'T11', cavalry_tg: 'TG8', archer_tier: 'T11', archer_tg: 'TG8' },
];
