...
export default function PetPackOptimizer() {
  ...
  return <section className="ppo-shell">
    <div className="ppo-inputs">
      <div className="ppo-panel-head"><div><h2>Set your target</h2><p>Enter the materials required and what is already in your bag.</p></div><span>Weekly limit enabled</span></div>
      ...
      <p className="ppo-rule">Each Common, Uncommon, Rare, Epic, and Legendary pack may be purchased once per week. The plan can repeat those purchases in later weeks.</p>
    </div>
    ...
    <style>{`
      ...
      .ppo-results{min-height:540px;overflow:hidden}.ppo-empty{min-height:540px;display:flex;align-items:center;justify-content:center;flex-direction:column;text-align:center;padding:40px}.ppo-empty>span{font-size:40px;color:var(--brass)}.ppo-empty p{max-width:48ch}.ppo-covered>span{color:#a8cc96}
