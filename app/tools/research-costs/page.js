...
export default function ResearchTools(){return <ToolsHub title="Research Tools" description="Plan Academy and War Academy upgrades using per-level resource costs and research times." tools={[
