...
// Guides, Events, Rankings, and Tools are member-gated (proxy.js) - they
// intentionally do not appear here, in robots.js, or carry canonical/
// JSON-LD tags, since search engines can no longer reach them.
const STATIC_ROUTES = [
...
export default async function sitemap() {
  const alliances = await allianceEntries();
  ...
  return [...staticEntries, ...alliances];
}
